...
Muri_SJF_JCT_raw = [918415.301659, 1641772.989397, 1559715.009066, 2696661.382746, 84474.519546, 563290.031930, 375884.261951, 1048478.402955]
Muri_FIFO_JCT_raw = [5568512.160071, 8469732.738033, 18127182.396201, 21810519.412319, 100798.501635, 2395214.831423, 1722540.851275, 4871067.787687]
...
Muri_SJF_Makespan_raw = [18531178.302708, 16456680.990600, 33113502.942515, 31895487.896830, 8174135.280030, 4695571.342364, 10996730.740841, 10116121.404140]
Muri_FIFO_Makespan_raw = [17402457.499414, 15446597.729224, 33340413.462360, 32597763.430162, 8174135.280030, 4629082.487355, 10520811.092681, 9439471.929349]
...
Muri_SJF_99JCT_raw = [11347165.607194, 13506423.684650, 21525153.998503, 23941724.432968, 948621.236982, 3982851.548034, 3797438.311743, 6493376.925760]
Muri_FIFO_99JCT_raw = [13541685.351747, 13570237.476629, 27070297.508711, 28629972.518982, 905438.093987, 3940314.847513, 4953413.210330, 7199186.493041]
...
Muri_SJF_JCT = [a/b for a,b in zip(Muri_SJF_JCT_raw, Muri_S_JCT_raw)]
Muri_FIFO_JCT = [a/b for a,b in zip(Muri_FIFO_JCT_raw, Muri_S_JCT_raw)]
...
Muri_SJF_Makespan = [a/b for a,b in zip(Muri_SJF_Makespan_raw, Muri_S_Makespan_raw)]
Muri_FIFO_Makespan = [a/b for a,b in zip(Muri_FIFO_Makespan_raw, Muri_S_Makespan_raw)]
...
Muri_SJF_99JCT = [a/b for a,b in zip(Muri_SJF_99JCT_raw, Muri_S_99JCT_raw)]
Muri_FIFO_99JCT = [a/b for a,b in zip(Muri_FIFO_99JCT_raw, Muri_S_99JCT_raw)]
...
def draw5_new(title:str, name_lists:list, lists:list, ncol=3):
    plt.clf()
    plt.rc('font',**{'size': 42, 'family': 'Arial' })
    plt.rc('pdf',fonttype = 42)
#    trace = [str(i) for i in range(1, len(lists[0]) + 1)]
...
draw5_new('Normalized\nAverage JCT', ['SRTF', 'SRSF', 'Muri-S', 'Muri-SJF', 'Muri-FIFO'], [SRTF_JCT, SRSF_JCT, Muri_S_JCT, Muri_SJF_JCT, Muri_FIFO_JCT])
...
draw5_new('Normalized\nMakespan', ['SRTF', 'SRSF', 'Muri-S', 'Muri-SJF', 'Muri-FIFO'], [SRTF_Makespan, SRSF_Makespan, Muri_S_Makespan, Muri_SJF_Makespan, Muri_FIFO_Makespan])
...
draw5_new('Normalized\n99th%-ile JCT', ['SRTF', 'SRSF', 'Muri-S', 'Muri-SJF', 'Muri-FIFO'], [SRTF_99JCT, SRSF_99JCT, Muri_S_99JCT, Muri_SJF_99JCT, Muri_FIFO_99JCT])
